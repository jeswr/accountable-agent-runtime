...
export const RUNTIME_PROTOCOL_ID = "https://institute.example/protocols/data-sharing.ttl" as const;
 ...
 */
export async function buildRuntimeProtocolDocument(): Promise<ProtocolDocument> {
  return buildProtocolDocument({
    ...
    meta: {
      ...
      description:
        "Negotiate read access to selected pod records for a stated purpose and bounded period.",
      version: "1",
    },
  });
}
