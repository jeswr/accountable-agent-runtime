...
import { PROV_ACTED_ON_BEHALF_OF, PROV_ACTIVITY, PROV_AGENT, PROV_ASSOCIATION, PROV_ENDED_AT_TIME, PROV_GENERATED, PROV_HAD_PLAN, PROV_QUALIFIED_ASSOCIATION, PROV_STARTED_AT_TIME, PROV_USED, PROV_WAS_ASSOCIATED_WITH, PROV_WAS_DERIVED_FROM, PROV_WAS_GENERATED_BY, XSD_DATETIME, } from "../vocab.js";
function asArray(v) {
    if (v === undefined) {
        return [];
    }
 ...
 */
export function actionProvenance(input) {
