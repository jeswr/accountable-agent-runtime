...
export function buildLiveAgreement(cast) {
    return {
        id: cast.agreementId,
        type: "Agreement",
        profile: ODRLD_PROFILE_IRI,
 ...
 */
export function buildLiveInstituteInternal(cast) {
    return {
