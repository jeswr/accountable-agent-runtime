...
export async function auditLive(options) {
    ...
    try {
        ...
        const activity = trace.graph.getQuads(namedNode(options.artifact), namedNode(PROV_WAS_GENERATED_BY), null, null)[0]?.object.value;
        const startedAt = activity !== undefined
        ...
        report = await auditArtifact(trace, options.artifact, {
            ...
            resolveStatus: liveStatusResolver(discoveryFetch, statusInstant !== undefined ? { now: statusInstant } : {}),
